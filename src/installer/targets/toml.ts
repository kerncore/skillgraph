 ...
 * single dotted-key table block (`[mcp_servers.skillgraph]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.skillgraph]`
 ...
 *     the full dotted key `[mcp_servers.skillgraph]`).
